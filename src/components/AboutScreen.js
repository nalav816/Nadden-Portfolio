    ...
    return (
        <div className = "AboutScreen-Container" id = "About">
            ...
            <div className = "AboutScreen-AboutBox">
                ...
                <p className = "AboutScreen-Paragraph">This is my life story. Here I type random stuff to make up the needed words for a nice little paragraph.
            ...
            <div className = "AboutScreen-AboutBox AboutScreen-SkillAboutBox ">
                ...
                <div className="AboutScreen-SkillRow">
                    {skills.map((skill, index) => {
                        <div className = "AboutScreen-SkillColumn">
